      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Daily Collection</a>
          </div>
          ...
          <div class="col-lg-6 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                <iframe id="test" src="dailyReport.php" class="col-12" style="overflow: hidden; border: none;" width="100%" height="500px" frameborder="yes" name="myIframe" id="myIframe"> </iframe>
                </div>
              </div>
                <div class="card-footer d-flex justify-content-end">
                
                <a href="#!" data-id="" onclick="printDaily();" class="btn btn-success d-flex align-items-center justify-content-center" style="height: 40px;"><i class="material-icons mr-1">text_snippet</i>PRINT REPORT</a>  
              ...
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title text-center">SEF</h4>
                  
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-12">
                    <iframe id="test" src="dailyReport_sef.php" class="col-12" style="overflow: hidden; border: none;" width="100%" height="500px" frameborder="yes" name="myIframe" id="myIframe"> </iframe>
                </div>
              </div>
                <div class="card-footer d-flex justify-content-end">
                
                <a href="#!" onclick="printDaily();" class="btn btn-success d-flex align-items-center justify-content-center" style="height: 40px;"><i class="material-icons mr-1">text_snippet</i>PRINT REPORT</a>
...
<div class="modal fade" id="dailyReportModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
            <iframe id="daily" src="dailyReport.php" class="col-12" style="overflow: hidden; border: none;" width="100%" height="600px" frameborder="yes"> </iframe>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <button type="submit" id="printReport" name="printReport" onclick="printDaily();" class="btn btn-success">Print Report</button>
  ...
  <div class="modal fade" id="dailyReportModal_sef" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Daily Report</h5>
        ...
        <div class="modal-body">
          <div class="container">
            <iframe id="daily" src="dailyReport_sef.php" class="col-12" style="overflow: hidden; border: none;" width="100%" height="600px" frameborder="yes"> </iframe>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          ...
          <form>
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="date" class="form-control" id="selectDate1" name="selectDate1">
              ...
              <div class="col-md-12 mb-0 py-0">
                <div style="background-color:#d2f4ea; height: 45px; font-weight: 400; font-size: 12px;" class="alert alert-dark alert-sm d-flex align-items-center" role="alert">
                  Input date on first only if you want to filter for a specific date.
                </div>
              </div>
            </div>
...
<script>
       ...
       function printDaily() {
      var dailyReport = document.getElementById('daily').contentWindow;
      dailyReport.focus();
      dailyReport.print();
      return false;
    }
