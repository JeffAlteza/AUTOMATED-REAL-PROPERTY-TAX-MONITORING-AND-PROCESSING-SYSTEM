...
function DLDbBackup(){
  //ENTER THE RELEVANT INFO BELOW
 $mysqlUserName      = "u195988426_agoncillo";
 $mysqlPassword      = "TX1*HVu#8";
 $mysqlHostName      = "localhost";
 $DbName             = "u195988426_rpt";
 $backup_name        = "mybackup.sql";
 $tables             = "poblacion";
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Utilities</a>
          </div>
      ...
      <div class="col-lg-3 col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                <div class="container-fluid">
                    <button type="button" id="backUp" name="backUp" data-bs-toggle="modal" data-bs-target="#backupData" class="btn btn-block btn-secondary" style="height: 180px;">
                    <img src="../images/database-icon.png" width="150px" height="150px">
       ...
       <div class="col-md-6">
       <button type="submit" id="backUp" name="backUp" class="btn btn-success"><i class="material-icons">file_download</i> &nbsp; Backup</button>
       </div>
       </form>
                </div>
              </div>
...
document.write(new Date().getFullYear());
    ...
    <div class="modal fade" id="successUpdatePassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
     ...
     <div class="modal fade" id="backupData" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <h5>
              <center>Please backup your database regularly. Thankyou!</center>
              </h5>
          </div>
          <div class="modal-footer">
            <button type="button" id="update_success" class="btn btn-success" data-bs-dismiss="modal">Close</button>
          </div>
        </div>
      </div>
    </div>
